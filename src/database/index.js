...
for (let assoc of Object.keys(ProductBacklog.associations)) {
    for (let accessor of Object.keys(ProductBacklog.associations[assoc].accessors)) {
        console.log(ProductBacklog.name + '.' + ProductBacklog.associations[assoc].accessors[accessor] + '()');
    }
}
